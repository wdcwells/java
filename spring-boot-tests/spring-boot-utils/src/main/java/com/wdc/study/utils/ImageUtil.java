...
public class ImageUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream in = null;
        //缩放后需要保存的路径
        File saveFile = new File("/Users/wdc/tmp/tests/images/compress/backgroud2_compress2.jpg");
        try {
            //原图片的路径
            in = new FileInputStream(new File("/Users/wdc/tmp/tests/images/compress/backgroud2.jpg"));
